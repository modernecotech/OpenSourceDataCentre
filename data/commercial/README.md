...
This directory stores machine-readable catalogues for commercial datacentre readiness.

- `commercial-gap-register.csv` is the source of truth for commercial-readiness gaps and the next artifact needed to close each gap.
- `standards-control-matrix.csv` maps candidate standards/control families to OSDC design responses and evidence locations.
- `sla-classes.csv` defines service-level classes for power, cooling, network, remote hands, and cloud platform services.
