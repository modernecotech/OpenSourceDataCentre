...
These images are project-bound documentation assets generated with the built-in image generation tool.

- `prefab-panel-datacentre-exterior-01.png`: exterior concept for a fast-production insulated panel datacentre with solar and thermal plant.
...
- Fast-production insulated metal sandwich panel building.
- Solar canopy, dry cooler, thermal plant skid, and secure service yard.
- Rack thermal spine cooling with red hot-loop and blue cold-loop pipework.
- No logos, brands, watermarks, or text labels.
